...
export const HomePage = () => {
  ...
  const searchHandler = () => {
    axios
      .get("https://bronze-wildebeest-belt.cyclic.app/employees/search", {
  ...
  useEffect(() => {
    axios
      .get(`https://bronze-wildebeest-belt.cyclic.app/employees?firstName=${search}`)
      .then((res) => {
        setEmp(res.data.employees);
        console.log(res.data);
      });
  ...
  const deleteHandler = (id) => {
    axios.delete(`https://bronze-wildebeest-belt.cyclic.app/employees/${id}`).then((res) => {
